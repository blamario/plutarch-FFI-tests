{
  ...
  outputs = inputs@{ self, nixpkgs, haskell-nix, plutus, plutus-apps, flake-compat, flake-compat-ci, hercules-ci-effects }:
    let
    ...
    in
    {
            ...
            hci-effects.mkEffect {
              ...
              effectScript =
                ...
                ''
                  ...
                  git init -b gh-pages
                  git remote add origin git@github.com:mlabs-haskell/plutarch-FFI-tests.git
                  git add .
      ...
      ciNix = args: flake-compat-ci.lib.recurseIntoFlakeWith {
        flake = self;
